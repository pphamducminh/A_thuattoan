...
void solve(){
    ...
    // tich co huong phai bang 0, vi bang 0 se cung phuong
    if ((OT^OA)!=0) {
        return cout << "NO", void(); 
    }


    // OA phai cung huong voi OT va TA phai cung huong voi TO
    if (OA.x * OT.x >= 0 && OA.y * OT.y >= 0 && TA.x * TO.x >= 0 && TA.y * TO.y >= 0) {
